...
import mainLogo from "../images/mainNDlogo.png";
...
export default function AdminDashboard() {
  ...
  const handleLogout = () => {
    localStorage.removeItem("N_admin");
    localStorage.removeItem("N_admin_email");
            ...
            <div className="bg-white p-6 rounded-lg shadow-xl max-w-lg w-full relative">
              ...
              <div className="space-y-3 text-left">
                ...
                <div>
                  ...
                  <span className="ml-2">{selected.mobile || "-"}</span>
                </div>
