      ...
      <div className="max-w-4xl mx-auto px-6 md:px-12 py-20 space-y-16">
        ...
        <section>
          ...
          <p className="text-gray-700 leading-relaxed text-base md:text-lg">
            ...
            this advertisement as updated, correct, complete, and accurate,
            nevertheless, inadvertent errors may occur in the information.
          </p>
        </section>
        ...
        <section>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              and do not constitute a legal offer, invitation, or commitment.
            </p>
          </div>
          ...
          <div className="mb-6">
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              including merchantability or fitness for a particular purpose, are
              disclaimed.
            </p>
          </div>
